...
//  csstest
//
//  Created by YIZE LIN on 2017/11/21.
...
@interface ViewController () <HIListViewDelegate>

@property (nonatomic, strong) HIListView *listView;
...
- (void)viewDidLoad {
    ...
    [self.listView setHIML:
     ...
     @"  font-size: 40px;"
     @"  font-color: gray;"
     @"  -ios-constraints: top 15,left 10 titleLabel right,right -15, height 50;"
     @"}"
     @".textAndImage img {"
